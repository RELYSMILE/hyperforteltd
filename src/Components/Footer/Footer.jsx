        ...
        <div className='app-footer-logo-container'>
            <div className='footer-logo-container'>
                <div className='logo-container'>
                    ...
                    <img src={logo_alpha} className='logo_alpha' />
                </div>
                <div className='info'>Hyper Forte Solution has been outstanding with their Rentals & Hires service. The equipment is always reliable, well-maintained, and delivered right on schedule. It has truly streamlined our projects.</div>
            ...
            <div className='qiuck-links'>
                ...
                <a href={`#${homeId}`} className='link'>Home</a>
                <div className='link'>About Us</div>
                <a href='https://wa.me/2349021463046' target='_blank' className='link'>Contact Us</a><br /><br />
            </div>
            <div className='qiuck-links'>
                ...
                <div className='contact'>
                    <img src={call} alt="" />
                    <a href={`tel:+2349079167915`}>+234 (0) 9079167915</a>
                </div>
                <div className='contact'>
                    <img src={email} alt="" />
                    <a href={`mailto:info@hyperforteltd.com`}>info@hyperforteltd.com</a>
                </div>
                <div className='contact'>
                    <img src={email} alt="" />
                    <a href={`mailto:hyperforteltd@gmail.com`}>hyperforteltd@gmail.com</a>
                </div>
            </div>
        </div>
        <div className='Privacy'>
            <div className='copyright'>&copy; {new Date().getFullYear()} Hyperforte Solution. All rights reserved.</div>
